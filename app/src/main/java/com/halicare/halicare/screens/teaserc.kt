...
fun TeaserScreenThree(
    ...
    Box(
        ...
        Image(
            painter = painterResource(id = R.drawable.teaser_c),
        ...
        Column(
            ...
            Text(
                text = "Your health is more than physical.\n" +
                        " HaliCare connects you to professional \n" +
                        " counselling giving you peace of mind \n" +
